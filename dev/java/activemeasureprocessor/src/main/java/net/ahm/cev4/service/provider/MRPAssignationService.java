...
/**
 * Most Recent Provider Assignation Service
 * @author mkitawat
 *
 */
public class MRPAssignationService extends AbstractJustificationBasedAssignationService implements Comparator<ProviderStats> {

	@Override
	public ProviderAssignationEnum getProviderAssignationCode() {
		return ProviderAssignationEnum.MRPROV;
	}
	...
	public int compare(ProviderStats o1, ProviderStats o2) {
		//order by recentDate desc, count desc, careProviderId asc (nulls last)
		if (o2 == null) return -1;
		if (o1 == null) return 1;
		int cmp = o2.getMaxDate().compareTo(o1.getMaxDate());
		if (cmp != 0) return cmp;
