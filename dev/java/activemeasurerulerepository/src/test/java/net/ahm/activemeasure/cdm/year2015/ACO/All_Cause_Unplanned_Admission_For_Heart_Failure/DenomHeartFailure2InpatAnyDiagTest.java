...
//1.	|	rule "DENOM_HEART_FAILURE_2_INPAT_ANY_DIAG"
//2.	|	    dialect "mvel"
//3.	|	    when
//4.	|	         ActiveMeasuresMemberInfo( ageAtMeasurementEndDate >= 65 , gender != null )
//5.	|	         $outPatClaimHeaderEvents : java.util.Collection( size >= 2 ) from collect ( ClaimHeader( endDate <= measurementEndDate , inpatient == true , allDiagnosticEventElements contains 7932 , endDate >= months24BeforeMeasurementEndDate ))
//6.	|	    then
...
public class DenomHeartFailure2InpatAnyDiagTest extends AbstractActiveMeasuresRuleTemplateTest {
    ...
    public DefaultStandardRuleTemplate getRuleInstance() {
        return UtilFunctions.createDefaultStandardRuleTemplate(
                "DENOM_HEART_FAILURE_2_INPAT_ANY_DIAG",
