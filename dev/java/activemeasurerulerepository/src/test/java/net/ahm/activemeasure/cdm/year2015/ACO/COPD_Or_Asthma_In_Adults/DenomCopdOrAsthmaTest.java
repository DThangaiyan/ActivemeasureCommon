...
//rule "DENOM_COPD_OR_ASTHMA"
//dialect "mvel"
//when
//     ActiveMeasuresMemberInfo( ageAtMeasurementEndDate >= 40 , gender != null )
//     $claimHdr : ClaimHeader( principalDiagnosisElements contains 7931  || contains 8834 , endDate <= measurementEndDate , endDate >= months12BeforeMeasurementEndDate )
//then
...
public class DenomCopdOrAsthmaTest extends
                                                        ...
                                                        new AttributeFragmentTemplate(
                                                                ...
                                                                TypeDescription
                                                                        .getTypeDescription(
                                                                                ...
                                                                                Integer.class)),
                                                        UtilFunctions
                                                                .createIntegerLiteralFragmentTemplate(8834),
                                                        CommonOperators.CONTAINS,
                                                        null)),
                        UtilFunctions
